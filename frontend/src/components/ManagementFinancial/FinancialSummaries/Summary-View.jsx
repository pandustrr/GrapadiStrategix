import { Edit3, Calendar, TrendingUp, TrendingDown, DollarSign, Wallet, BarChart3, FileText } from 'lucide-react';
            ...
            <div className="mb-2">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Lihat informasi lengkap ringkasan keuangan</p>
                    </div>
                    <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span className={`font-medium ${
                                ...
                                {summary.net_profit >= 0 ? 'Profit' : 'Rugi'}
                            </span>
                        </div>
                        <div>
