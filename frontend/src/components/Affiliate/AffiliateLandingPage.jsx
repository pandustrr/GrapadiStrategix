          ...
          <div className="text-center mb-8">
            ...
            <div className="mb-6 flex justify-center">
              {businessData.logo_url ? (
                <div className="w-24 h-24 bg-white rounded-2xl shadow-2xl flex items-center justify-center overflow-hidden p-2 transition-transform duration-200 hover:scale-105">
                  <img
                  ...
                  />
                  <div
                    className="w-full h-full flex items-center justify-center bg-gradient-to-br from-green-100 to-blue-100 rounded-xl hidden"
                    style={{ display: "none" }}
                  >
              ...
              <form onSubmit={handleSubmitLead} className="p-8 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-lg border-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ${
                      formErrors.name
                ...
                <div className="space-y-3">
                  ...
                  {businessData.phone && (
                    <a
                      ...
                      className="flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-all duration-200 border border-purple-200 dark:border-purple-800 hover:border-purple-400 dark:hover:border-purple-600"
                    >
